...
public class SchoolAdminController {
    ...
    public Map<String, Object> updateAnomalyPolicy(
        ...
        var policy = anomalyPolicyService.updatePolicy(schoolId, req.warningThreshold(), req.severeThreshold(), req.sampleIntervalMs(), req.identityVerifyIntervalSec(),req.evidenceMediaType(), req.maxReconnectCount());
        return Map.of("ok", true, "policy", anomalyPolicyService.asMap(policy));
    }
